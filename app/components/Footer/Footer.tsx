    ...
    <footer className="bg-gray-200 dark:bg-gray-800 dark:text-gray-50">
      <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-gray-400">
        <ul className="self-center py-6 space-y-4 text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
          <li>
            <Link href={NAV_ITEMS.home.path}>Home</Link>
          </li>
          <li>
            <Link href={NAV_ITEMS.projects.path}>Projects</Link>
          </li>
          <li>
            <Link href={NAV_ITEMS.contact.path}>Contact</Link>
          </li>
        </ul>
        <div className="flex justify-center items-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
          <a
            rel="noopener noreferrer"
            href={NAV_ITEMS.contact.path}
            title="Email"
          ...
          <a
            rel="noopener noreferrer"
            href="https://github.com/razzle-dazzle"
            title="GitHub"
            target="_blank"
            className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-gray-900"
          >
